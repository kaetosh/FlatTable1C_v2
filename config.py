...
В случае неактивности данной опцией, свяжитесь с разработчиком, он подскажет, как сделать ее активной.
Убедитесь, что для Анализа счета субконто корреспондирующих счетов не превышает одного уровня вложенности.
Например, для корреспондирующего счета учета расчетов это может контрагент или договор, но не контрагент и договор.
Например, для корреспондирующего счета учета запасов - номенклатура или вид номенклатуры, но не вид номенклатуры и номентклатура.
Аналитика для основного счета - без ограничений уровня вложенности для всех трех типов регистра.
Допускается установка опции Период (по мес, кв и т.д.), но проверка сальдо для ОСВ и Оборотов счета будет работать некорректно из-за переходящих остатков между периодами.
'''
